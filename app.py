...
# Termasuk pengasingan Weekdays (WD) dan Weekends/Cuti Umum (WE)
REKOD_SEP_2026 = {
    ...
    "INSP KASHMINDEJRIT KAUR A/P CHARLES": {"WD": 0, "WE": 1},  # 16/09 Hari Malaysia (Cuti Umum)
    "INSP FAIZ BIN BASAR": {"WD": 0, "WE": 1},                # 16/09 Hari Malaysia (Cuti Umum)
...
if st.button("🚀 Jana Jadual Penugasan", type="primary"):
    ...
    def pilih_pegawai(is_wknd, elak_set):
        ...
        def dapatkan_skor(nama_pegawai):
            ...
            if is_wknd:
                # Keutamaan hujung minggu: Jumlah WE bulan ini * 100 + WE Sept * 10 + Jumlah Tugas Bulan Ini
                return (tugas_we[nama_pegawai] * 100) + (rec["WE"] * 10) + (tugas_wd[nama_pegawai] + tugas_we[nama_pegawai])
            else:
                # Keutamaan hari biasa: Jumlah WD bulan ini * 100 + WD Sept * 10 + Jumlah Tugas Bulan Ini

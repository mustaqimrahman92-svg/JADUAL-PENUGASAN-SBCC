...
def init_db():
    ...
    c = conn.cursor()
    # Cipta jadual sekiranya belum ada
    c.execute('''
    ...
    # Auto-Migration: Tambah lajur tarikh_disahkan sekiranya tiada dalam DB sedia ada
...
def ambil_jadual_db(bulan, tahun):
    ...
    if 'Tarikh Disahkan' not in df.columns:
        df['Tarikh Disahkan'] = "Rekod Lama"

...
# ==========================================
tab1, tab2, tab3 = st.tabs(["⚙️ Penjanaan Jadual Baru", "📜 Rekod Sejarah & Format Cetak", "✏️ Edit & Kemaskini Rekod"])
...
with tab1:
    ...
    if st.button("🚀 Jana Jadual Penugasan", type="primary"):
        ...
        for dt in senarai_tarikh:
            ...
            # Penukaran nama hari ke Bahasa Melayu
...
# ==========================================
# TAB 3: EDIT & KEMASKINI REKOD
# ==========================================
with tab3:
    st.subheader("✏️ Edit & Kemaskini Rekod Pangkalan Data")
    ...
    if not df_edit.empty:
        st.info("💡 **Petua:** Anda boleh menukar terus teks/pilihan dalam jadual di bawah. Setelah selesai, tekan butang **'💾 Simpan Perubahan'** di bawah.")
        ...
        if st.button("💾 Simpan Perubahan", type="primary"):
            ...
            st.success(f"✅ Rekod bagi Bulan {bulan_edit}/{tahun_edit} berjaya dikemaskini!")
            st.rerun()
    else:
        st.warning(f"Tiada rekod jadual ditemui bagi Bulan {bulan_edit}/{tahun_edit} untuk di-edit. Sila sahkan jadual di Tab 1 terlebih dahulu.")

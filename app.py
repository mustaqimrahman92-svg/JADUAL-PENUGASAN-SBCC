...
def init_db():
    ...
    # Semak dan tambah lajur bhg jika belum wujud
...
def simpan_jadual_db(bulan, tahun, df_jadual):
    ...
    # Pemetaan lajur DataFrame ke Pangkalan Data
...
# ----------------------------------------------------
# FUNGSI JANA DOKUMEN WORD (.DOCX) NATIVE HTML/XML
# (TIDAK MEMERLUKAN PUSTAKA PYTHON-DOCX APAPUN!)
# ----------------------------------------------------

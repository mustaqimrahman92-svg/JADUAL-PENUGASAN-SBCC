...
# Rekod Tugas Terperinci Bulan September 2026 (Berdasarkan PDF Lampiran 'A')[span_1](start_span)[span_1](end_span)
REKOD_SEP_2026 = {
...
with col1:
    bulan = st.selectbox("Pilih Bulan", list(range(1, 13)), index=9)  # Default: Oktober
with col2:
...
if st.button("🚀 Jana Jadual Penugasan", type="primary"):
    ...
    def pilih_pegawai(is_wknd, elak_set):
        ...
        # SYARAT KHAS: Syarat ini HANYA berkuat kuasa jika bulan dipilih ialah OKTOBER (Bulan 10)[span_2](start_span)[span_2](end_span)

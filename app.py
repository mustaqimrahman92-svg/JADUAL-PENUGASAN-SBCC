...
# REKOD BULAN SEPTEMBER 2026
REKOD_SEP_2026 = {
    "INSP ROHAIZASHAFIKA BINTI MOHAMAD RADZALI": {"WD": 2, "WE": 0},
    "INSP WAN MUHAMAD MUSTAQIM BIN ABDUL RAHMAN": {"WD": 1, "WE": 1},
    "INSP MUHAMAD IQRAM BIN MOHAMAD BUKHARI": {"WD": 1, "WE": 1},
    "INSP ADDLYZAN BIN ABD MANAP": {"WD": 1, "WE": 1},
    ...
    "INSP MOHD RUSDI BIN HASSAN": {"WD": 0, "WE": 1},
...
with tab1:
    ...
    if st.button("🚀 Jana Jadual Penugasan", type="primary"):
        ...
        def pilih_pegawai(is_wknd, elak_set, is_jumaat=False):
            ...
            # 1. PENAPISAN GILIRAN LELAKI WEEKEND
            ...
            # 3. HAD MAKSIMUM TUGASAN DINAMIK (PENGGILIRAN 1 KALI / 2 KALI)
        ...
        for dt in senarai_tarikh:
            ...
            if is_weekend:
                ...
                if k_s in override_dict:
                    ...
                    tugas_we[p_s] += 1  # Kemas kini kaunter terus untuk manual assignment
                else:
                ...
                if k_m in override_dict:
                    ...
                    tugas_we[p_m] += 1  # Kemas kini kaunter terus untuk manual assignment
                else:
                ...
                if k_b in override_dict:
                    ...
                    tugas_wd[p_b] += 1  # Kemas kini kaunter terus untuk manual assignment
                    if is_jumaat:
...
with tab2:
    ...
    if not df_rekod.empty:
        ...
        for idx, p in enumerate(PEGAWAI, start=1):
            ...
            # Fallback paparan rekod manual September jika tiada rekod SQLite

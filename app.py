...
with tab1:
    ...
    # Menyemak jika draf wujud dalam database
    ...
    if 'df_jadual_temp' in st.session_state and st.session_state['bulan_temp'] == bulan and st.session_state['tahun_temp'] == tahun:
        ...
        st.info("💡 **Petua Edit:** Anda boleh sunting terus petak di bawah sebelum menyimpan Draf atau Mengesahkan Jadual.")
